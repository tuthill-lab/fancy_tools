...
def get_segment_fcn_order(**kwargs):
    ...
    if 'side' in kwargs.keys():
        if kwargs['side'] is 'left':
            print(kwargs)
            return reorder_L_bysegfcn
        elif kwargs['side'] is 'right':
            print(kwargs)
...
def get_motor_pool_tuple_dict():
    ...
    motor_pool_tuple_dict = {
        'thorax_swing':                                             ('L','Accessory', 'thorax', 'swing', ['sternal_posterior_rotator_miller_32','pleural_remotor_and_abductor_miller_29'], All,All),
        'sternal_posterior_rotator_miller_32':                      ('L','Accessory', 'thorax', 'swing', 'sternal_posterior_rotator_miller_32', All,All),
        'pleural_remotor_and_abductor_miller_29':                   ('L','Accessory', 'thorax', 'swing', 'pleural_remotor_and_abductor_miller_29', All,All),
        
        'thorax_stance':                                            ('L',All, 'thorax', 'stance', ['sternal_anterior_rotator_miller_31','sternal_adductor_miller_miller_in_thorax_miller_33','tergopleural_promotor_pleural_promotor_miller_28_30'], All,All),
        'sternal_anterior_rotator_miller_31':                       ('L','Ventral', 'thorax', 'stance', 'sternal_anterior_rotator_miller_31', All,All),
        'sternal_adductor_miller_miller_in_thorax_miller_33':       ('L','Accessory', 'thorax', 'stance', 'sternal_adductor_miller_miller_in_thorax_miller_33', All,All),
        'tergopleural_promotor_pleural_promotor_miller_28_30':      ('L', 'Dorsal', 'thorax', 'stance', 'tergopleural_promotor_pleural_promotor_miller_28_30', All,All),
...
def sort_segment_fcn_index(col_idx):
